...
function onFileSelected(event) {
    ...
    reader.addEventListener("loadend", function() {             
        ...
        fetch('https://hoangng719-dog-cat-classifier.hf.space/run/predict', {
            method: "POST",
            ...
            .then(function(response) {
              ...
              .then(function(json_response) {
                ...
                const firstLabelConfidence = (json_response?.data[0]?.confidences[0]?.confidence*100).toFixed(2)
                const secondLabel = json_response?.data[0]?.confidences[1]?.label;
                const secondLabelConfidence = (json_response?.data[0]?.confidences[1]?.confidence*100).toFixed(2)
